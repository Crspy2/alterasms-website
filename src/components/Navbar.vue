...
<template>
  <header class="sm:px-4 py-4 top-0 fixed w-full z-20 left-0" :class="{ 'backdrop-blur-[10px] saturate-[180%] bg-[rgba(0,0,0,0.5)] transition duration-500' : scrolled > 1, 'bg-transparent transition duration-200' : scrolled <= 1 }">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="flex md:order-2">
        ...
        <a href="/tos" target="_blank">
          <button type="button" class="text-gray-300 hover:text-zinc-400 font-bold rounded-lg text-sm px-3 py-2.5 text-center md:mr-0 mr-3 select-none">
            TOS
          </button>
        </a>
      </div>
